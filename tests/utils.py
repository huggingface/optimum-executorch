...
def check_causal_lm_output_quality(model_id: str, generated_tokens: torch.Tensor, max_perplexity_threshold: float=100.0):
    """
...
def check_multimodal_output_quality(model_id: str, generated_tokens: torch.Tensor, conversation: List[Any], max_perplexity_threshold: float=100.0):
    """
